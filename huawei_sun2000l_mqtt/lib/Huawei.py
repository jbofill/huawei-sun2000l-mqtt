...
register_map = {
    'Model': {'num': 1, 'measurement': 'equipment', 'fieldname': 'Model', 'addr': '30000', 'registers': 15,
              'description': _('Model'), 'group': 'equipment', 'scale': 1, 'type': 'str', 'units': '', 'use': 'info',
              'method': 'hold'},
    'SN': {'num': 2, 'measurement': 'equipment', 'fieldname': 'SN', 'addr': '30015', 'registers': 10,
           'description': _('Serial Number'), 'group': 'equipment', 'scale': 1, 'type': 'str', 'units': '', 'use': 'info',
           'method': 'hold'},
    'strings': {'num': 5, 'measurement': 'equipment', 'fieldname': 'strings', 'addr': '30071', 'registers': 1,
                'description': _('Number of strings'), 'group': 'equipment', 'scale': 1, 'type': 'U16', 'units': '',
                'use': 'info', 'method': 'hold'},
    'Pn': {'num': 7, 'measurement': 'equipment', 'fieldname': 'Pn', 'addr': '30073', 'registers': 2,
           'description': _('Rated power'), 'group': 'equipment', 'scale': 1000, 'type': 'U32', 'units': 'kW', 'use': 'info',
           'method': 'hold'},
    'Pmax': {'num': 8, 'measurement': 'equipment', 'fieldname': 'Pmax', 'addr': '30075', 'registers': 2,
             'description': _('Maximum active power'), 'group': 'equipment', 'scale': 1000, 'type': 'U32', 'units': 'kW',
             'use': 'info', 'method': 'hold'},
    'Smax': {'num': 9, 'measurement': 'equipment', 'fieldname': 'Smax', 'addr': '30077', 'registers': 2,
             'description': _('Maximum apparent power'), 'group': 'equipment', 'scale': 1000, 'type': 'U32', 'units': 'kVA',
             'use': 'info', 'method': 'hold'},
    'Qmax': {'num': 10, 'measurement': 'equipment', 'fieldname': 'Qmax', 'addr': '30079', 'registers': 2,
             'description': _('Maximum reactive power to grid'), 'group': 'equipment', 'scale': 1000, 'type': 'I32',
             'units': 'kVar', 'use': 'info', 'method': 'hold'},
    'Qgrid': {'num': 11, 'measurement': 'equipment', 'fieldname': 'Qgrid', 'addr': '30081', 'registers': 2,
              'description': _('Maximum reactive power from grid'), 'group': 'equipment', 'scale': 1000, 'type': 'I32',
              'units': 'kVar', 'use': 'info', 'method': 'hold'},
    'Insulation': {'num': 43, 'measurement': 'equipment', 'fieldname': 'Insulation', 'addr': '32088', 'registers': 1,
                   'description': _('Insulation resistance'), 'group': 'equipment', 'scale': 1000, 'type': 'U16', 'units': 'MΩ',
                   'use': 'info', 'method': 'hold'},
    'Start': {'num': 46, 'measurement': 'inverter', 'fieldname': 'Start', 'addr': '32091', 'registers': 2,
              'description': _('Startup time'), 'group': 'status', 'scale': 1, 'type': 'U32', 'units': 's', 'use': 'info',
              'method': 'hold'},
    'Shutdown': {'num': 47, 'measurement': 'inverter', 'fieldname': 'Shutdown', 'addr': '32093', 'registers': 2,
                 'description': _('Shutdown time'), 'group': 'status', 'scale': 1, 'type': 'U32', 'units': 's', 'use': 'info',
                 'method': 'hold'},
    'Time': {'num': 64, 'measurement': 'inverter', 'fieldname': 'Time', 'addr': '40000', 'registers': 2,
             'description': _('Current time'), 'group': 'status', 'scale': 1, 'type': 'U32', 'units': 's', 'use': 'info',
             'method': 'hold'},
    'Optim_tot': {'num': 61, 'measurement': 'optimizer', 'fieldname': 'Optim_tot', 'addr': '37200', 'registers': 1,
                  'description': _('Number of optimizers'), 'group': 'optimizers', 'scale': 1, 'type': 'U16', 'units': '',
                  'use': 'info', 'method': 'hold'},
    'Optim_on': {'num': 62, 'measurement': 'optimizer', 'fieldname': 'Optim_on', 'addr': '37201', 'registers': 1,
                 'description': _('Number of online optimizers'), 'group': 'optimizers', 'scale': 1, 'type': 'U16', 'units': '',
                 'use': 'info', 'method': 'hold'},
    'Optim_opt': {'num': 63, 'measurement': 'optimizer', 'fieldname': 'Optim_opt', 'addr': '37202', 'registers': 1,
                  'description': _('Optimizer Feature data'), 'group': 'optimizers', 'scale': 1, 'type': 'U16', 'units': '',
                  'use': 'info', 'method': 'hold'},
    'State1': {'num': 12, 'measurement': 'status', 'fieldname': 'state1', 'addr': '32000', 'registers': 1,
               'description': _('Status 1'), 'group': 'status', 'scale': 1, 'type': 'Bit16', 'units': '', 'use': 'stat',
               'method': 'hold'},
    'State2': {'num': 13, 'measurement': 'status', 'fieldname': 'state2', 'addr': '32002', 'registers': 1,
               'description': _('Status 2'), 'group': 'status', 'scale': 1, 'type': 'Bit16', 'units': '', 'use': 'stat',
               'method': 'hold'},
    'State3': {'num': 14, 'measurement': 'status', 'fieldname': 'state3', 'addr': '32003', 'registers': 2,
               'description': _('Status 3'), 'group': 'status', 'scale': 1, 'type': 'Bit32', 'units': '', 'use': 'stat',
               'method': 'hold'},
    'Alarm1': {'num': 15, 'measurement': 'alarm', 'fieldname': 'alarm1', 'addr': '32008', 'registers': 1,
               'description': _('Alarm 1'), 'group': 'alarm', 'scale': 1, 'type': 'Bit16', 'units': '', 'use': 'stat',
               'method': 'hold'},
    'Alarm2': {'num': 16, 'measurement': 'alarm', 'fieldname': 'alarm2', 'addr': '32009', 'registers': 1,
               'description': _('Alarm 2'), 'group': 'alarm', 'scale': 1, 'type': 'Bit16', 'units': '', 'use': 'stat',
               'method': 'hold'},
    'Alarm3': {'num': 17, 'measurement': 'alarm', 'fieldname': 'alarm3', 'addr': '32010', 'registers': 1,
               'description': _('Alarm 3'), 'group': 'alarm', 'scale': 1, 'type': 'Bit16', 'units': '', 'use': 'stat',
               'method': 'hold'},
    'Status': {'num': 44, 'measurement': 'inverter', 'fieldname': 'status', 'addr': '32089', 'registers': 1,
               'description': _('Device status'), 'group': 'status', 'scale': 1, 'type': 'U16', 'units': '', 'use': 'stat',
               'method': 'hold'},
    'Fault': {'num': 45, 'measurement': 'status', 'fieldname': 'fault_code', 'addr': '32090', 'registers': 1,
              'description': _('Fault code'), 'group': 'status', 'scale': 1, 'type': 'U16', 'units': '', 'use': 'stat',
              'method': 'hold'},
    'PV1_U': {'num': 18, 'measurement': 'panels', 'fieldname': 'panel1_V', 'addr': '32016', 'registers': 1,
              'description': _('PV1 voltage'), 'group': 'work-extra', 'scale': 10, 'type': 'I16', 'units': 'V', 'use': 'mult',
              'method': 'hold'},
    'PV1_I': {'num': 19, 'measurement': 'panels', 'fieldname': 'panel1_I', 'addr': '32017', 'registers': 1,
              'description': _('PV1 current'), 'group': 'work-extra', 'scale': 100, 'type': 'I16', 'units': 'A', 'use': 'mult',
              'method': 'hold'},
    'PV2_U': {'num': 20, 'measurement': 'panels', 'fieldname': 'panel2_V', 'addr': '32018', 'registers': 1,
              'description': _('PV2 voltage'), 'group': 'work-extra', 'scale': 10, 'type': 'I16', 'units': 'V', 'use': 'mult',
              'method': 'hold'},
    'PV2_I': {'num': 21, 'measurement': 'panels', 'fieldname': 'panel2_I', 'addr': '32019', 'registers': 1,
              'description': _('PV2 current'), 'group': 'work-extra', 'scale': 100, 'type': 'I16', 'units': 'A', 'use': 'mult',
              'method': 'hold'},
    'PV_P': {'num': 26, 'measurement': 'panels', 'fieldname': 'panel_P', 'addr': '32064', 'registers': 2,
             'description': _('Input power (entrada inversor)'), 'group': 'work', 'scale': 1000, 'type': 'I32', 'units': 'kW',
             'use': 'data', 'method': 'hold'},
    'U_A-B': {'num': 27, 'measurement': 'panels', 'fieldname': 'voltage_a_b', 'addr': '32066', 'registers': 1,
              'description': _('Line Voltage A-B'), 'group': 'work-extra', 'scale': 10, 'type': 'U16', 'units': 'V',
              'use': 'data', 'method': 'hold'},
    'U_B-C': {'num': 28, 'measurement': 'panels', 'fieldname': 'voltage_b_c', 'addr': '32067', 'registers': 1,
              'description': _('Line Voltage B-C'), 'group': '3fase', 'scale': 10, 'type': 'U16', 'units': 'V', 'use': 'ext',
              'method': 'hold'},
    'U_C-A': {'num': 29, 'measurement': 'panels', 'fieldname': 'voltage_c_a', 'addr': '32068', 'registers': 1,
              'description': _('Line Voltage C-A'), 'group': '3fase', 'scale': 10, 'type': 'U16', 'units': 'V', 'use': 'ext',
              'method': 'hold'},
    'U_A': {'num': 30, 'measurement': 'panels', 'fieldname': 'voltage_a', 'addr': '32069', 'registers': 1,
            'description': _('Phase Voltage A'), 'group': 'work-extra', 'scale': 10, 'type': 'U16', 'units': 'V', 'use': 'data',
            'method': 'hold'},
    'U_B': {'num': 31, 'measurement': 'panels', 'fieldname': 'voltage_b', 'addr': '32070', 'registers': 1,
            'description': _('Phase Voltage B'), 'group': 'work-extra', 'scale': 10, 'type': 'U16', 'units': 'V', 'use': 'data',
            'method': 'hold'},
    'U_C': {'num': 32, 'measurement': 'panels', 'fieldname': 'voltage_c', 'addr': '32071', 'registers': 1,
            'description': _('Phase Voltage C'), 'group': '3fase', 'scale': 10, 'type': 'U16', 'units': 'V', 'use': 'ext',
            'method': 'hold'},
    'I_A': {'num': 33, 'measurement': 'panels', 'fieldname': 'current_a', 'addr': '32072', 'registers': 2,
            'description': _('Phase Current A'), 'group': 'work', 'scale': 1000, 'type': 'I32', 'units': 'A', 'use': 'data',
            'method': 'hold'},
    'I_B': {'num': 34, 'measurement': 'panels', 'fieldname': 'current_b', 'addr': '32074', 'registers': 2,
            'description': _('Phase Current B'), 'group': '3fase', 'scale': 1000, 'type': 'I32', 'units': 'A', 'use': 'ext',
            'method': 'hold'},
    'I_C': {'num': 34, 'measurement': 'panels', 'fieldname': 'current_c', 'addr': '32076', 'registers': 2,
            'description': _('Phase Current C'), 'group': '3fase', 'scale': 1000, 'type': 'I32', 'units': 'A', 'use': 'ext',
            'method': 'hold'},
    ...
    'P_reactive': {'num': 38, 'measurement': 'panels', 'fieldname': 'reactive_power', 'addr': '32082', 'registers': 2,
                   'description': _('Reactive power'), 'group': 'work-extra', 'scale': 1000, 'type': 'I32', 'units': 'kVar',
                   'use': 'data', 'method': 'hold'},
    'PF': {'num': 39, 'measurement': 'panels', 'fieldname': 'power_factor', 'addr': '32084', 'registers': 1,
           'description': _('Power Factor'), 'group': 'work', 'scale': 1000, 'type': 'I16', 'units': '', 'use': 'data',
           'method': 'hold'},
    'Frequency': {'num': 40, 'measurement': 'panels', 'fieldname': 'frequency', 'addr': '32085', 'registers': 1,
                  'description': _('Grid frequency'), 'group': 'work-extra', 'scale': 100, 'type': 'U16', 'units': 'Hz',
                  'use': 'data', 'method': 'hold'},
    'η': {'num': 41, 'measurement': 'panels', 'fieldname': 'efficiency', 'addr': '32086', 'registers': 1,
          'description': _('Efficiency'), 'group': 'work', 'scale': 100, 'type': 'U16', 'units': '%', 'use': 'data',
          'method': 'hold'},
    'Temp': {'num': 42, 'measurement': 'inverter', 'fieldname': 'internal_temp', 'addr': '32087', 'registers': 1,
             'description': _('Internal temperature'), 'group': 'info', 'scale': 10, 'type': 'I16', 'units': '°C', 'use': 'data',
             'method': 'hold'},
    'P_accum': {'num': 48, 'measurement': 'panels', 'fieldname': 'accum_energy', 'addr': '32106', 'registers': 2,
                'description': _('Accumulated energy yield'), 'group': 'info', 'scale': 100, 'type': 'U32', 'units': 'kWh',
                'use': 'data', 'method': 'hold'},
    'P_daily': {'num': 49, 'measurement': 'panels', 'fieldname': 'daily_energy', 'addr': '32114', 'registers': 2,
                'description': _('Daily energy yield'), 'group': 'info', 'scale': 100, 'type': 'U32', 'units': 'kWh',
                'use': 'data', 'method': 'hold'},
    'M_P': {'num': 60, 'measurement': 'grid', 'fieldname': 'active_power', 'addr': '37113', 'registers': 2,
            'description': _('Active Grid power (<0 obtaning)'), 'group': 'monitor', 'scale': 1, 'type': 'I32', 'units': 'W',
            'use': 'data', 'method': 'hold'},
    'M_Pr': {'num': 0, 'measurement': 'grid', 'fieldname': 'reactive_power', 'addr': '37115', 'registers': 2,
             'description': _('Active Grid reactive power'), 'group': 'work', 'scale': 1, 'type': 'I32', 'units': 'VAR',
             'use': 'data', 'method': 'hold'},
    'M_A-U': {'num': 2, 'measurement': 'grid', 'fieldname': 'voltage', 'addr': '37101', 'registers': 2,
              'description': _('Active Grid A Voltage'), 'group': 'work', 'scale': 10, 'type': 'I32', 'units': 'V', 'use': 'data',
              'method': 'hold'},
    'M_B-U': {'num': 0, 'measurement': 'grid', 'fieldname': 'voltage_b', 'addr': '37103', 'registers': 2,
              'description': _('Active Grid B Voltage'), 'group': '3fase', 'scale': 10, 'type': 'I32', 'units': 'V',
              'use': 'data', 'method': 'hold'},
    'M_C-U': {'num': 0, 'measurement': 'grid', 'fieldname': 'voltage_c', 'addr': '37105', 'registers': 2,
              'description': _('Active Grid C Voltage'), 'group': '3fase', 'scale': 10, 'type': 'I32', 'units': 'V',
              'use': 'data', 'method': 'hold'},
    'M_A-I': {'num': 0, 'measurement': 'grid', 'fieldname': 'current', 'addr': '37107', 'registers': 2,
              'description': _('Active Grid A Current'), 'group': 'work', 'scale': 100, 'type': 'I32', 'units': 'I',
              'use': 'data', 'method': 'hold'},
    'M_B-I': {'num': 0, 'measurement': 'grid', 'fieldname': 'current_b', 'addr': '37109', 'registers': 2,
              'description': _('Active Grid B Current'), 'group': '3fase', 'scale': 100, 'type': 'I32', 'units': 'I',
              'use': 'data', 'method': 'hold'},
    'M_C-I': {'num': 0, 'measurement': 'grid', 'fieldname': 'current_c', 'addr': '37111', 'registers': 2,
              'description': _('Active Grid C Current'), 'group': '3fase', 'scale': 100, 'type': 'I32', 'units': 'I',
              'use': 'data', 'method': 'hold'},
    'M_PF': {'num': 0, 'measurement': 'grid', 'fieldname': 'power_factor', 'addr': '37117', 'registers': 1,
             'description': _('Active Grid PF'), 'group': 'work', 'scale': 1000, 'type': 'I16', 'units': '', 'use': 'data',
             'method': 'hold'},
    'M_Freq': {'num': 0, 'measurement': 'grid', 'fieldname': 'frequency', 'addr': '37118', 'registers': 1,
               'description': _('Active Grid Frequency'), 'group': 'work', 'scale': 100, 'type': 'I16', 'units': 'Hz',
               'use': 'data', 'method': 'hold'},
    'M_PExp': {'num': 12, 'measurement': 'grid', 'fieldname': 'exported_energy', 'addr': '37119', 'registers': 2,
               'description': _('Grid Accumulated Exported Energy'), 'group': 'work', 'scale': 100, 'type': 'I32', 'units': 'kWh',
               'use': 'data', 'method': 'hold'},
    'M_U_AB': {'num': 0, 'measurement': 'grid', 'fieldname': 'voltage_a_b', 'addr': '37126', 'registers': 2,
               'description': _('Active Grid A-B Voltage'), 'group': '3fase', 'scale': 10, 'type': 'I32', 'units': 'V',
               'use': 'data', 'method': 'hold'},
    'M_U_BC': {'num': 0, 'measurement': 'grid', 'fieldname': 'voltage_b_c', 'addr': '37128', 'registers': 2,
               'description': _('Active Grid B-C Voltage'), 'group': '3fase', 'scale': 10, 'type': 'I32', 'units': 'V',
               'use': 'data', 'method': 'hold'},
    'M_U_CA': {'num': 0, 'measurement': 'grid', 'fieldname': 'voltage_c_a', 'addr': '37130', 'registers': 2,
               'description': _('Active Grid C-A Voltage'), 'group': '3fase', 'scale': 10, 'type': 'I32', 'units': 'V',
               'use': 'data', 'method': 'hold'},
    'M_A-P': {'num': 0, 'measurement': 'grid', 'fieldname': 'power', 'addr': '37132', 'registers': 2,
              'description': _('Active Grid A power'), 'group': 'work', 'scale': 1, 'type': 'I32', 'units': 'W', 'use': 'data',
              'method': 'hold'},
    'M_B-P': {'num': 0, 'measurement': 'grid', 'fieldname': 'power_b', 'addr': '37134', 'registers': 2,
              'description': _('Active Grid B power'), 'group': '3fase', 'scale': 1, 'type': 'I32', 'units': 'W', 'use': 'data',
              'method': 'hold'},
